    ...
    <?php
        ...
        else
        {
            ...
            while($row = mysqli_fetch_assoc($result))
            {
                ...
                echo '<td> <a href="./edit1.php?id='.$row['teacherid'].'"><button class="btn"> EDIT Personal </button></a><br> <a href="./edit3.php?id='.$row['teacherid'].'"> <button class="btn"> EDIT Banking </button></a></td>';
